...
public class LesEmployeeDTO {
	...
	public LesEmployeeDTO() {}

	public LesEmployeeDTO(int empNo, String empId, String empName, Date empBirth, String empPwd, String empEndate,
