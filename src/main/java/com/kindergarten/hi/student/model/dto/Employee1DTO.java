...
public class Employee1DTO {
	...
	public Employee1DTO(int no, String id, String name, Date birth, String pwd, Date endate, String emall, String addre,
			String phone, String salary, String resign, Date restgndate, StudentDTO student) {
